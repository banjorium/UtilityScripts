...
ForEach($DC in $AllDomainControllers)
{
	...
	If($Hardware -or $Services -or $DCDNSInfo)
	{
		If(Test-Connection -ComputerName $DC.name -quiet -EA 0)
		{
			...
			If($DCDNSInfo)
			{
				BuildDCDNSIPConfigTable $DC.Name
			}
...
If($DCDNSInfo)
{
	...
	If($MSWord -or $PDF)
	{
		...
		-Columns DCName, DCIpAddress, DCDNS1, DCDNS2, DCDNS3, DCDNS4 `
		-Headers "DC Name", "IP Address", "Preferred DNS", "Alternate DNS", "DNS 3", "DNS 4" `
		-AutoFit $wdAutoFitContent;
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPcya3pA0vNehKkqd+7vLOTa5
# gL2gghtxMIIDtzCCAp+gAwIBAgIQDOfg5RfYRv6P5WD8G/AwOTANBgkqhkiG9w0B
...
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAjBgkqhkiG9w0BCQQxFgQUk0Gj1/cknbdqeAV0
# T16vaNOyaEUwDQYJKoZIhvcNAQEBBQAEggEAMidkpqOZts/OiPXvACrRdD2bEmQw
# LsbaNFafFxPpY1BYjbpSzKrj4mXxEMXuAOfJx6NXCScaX4qChJX7UyUepFuy0SmK
# W7vq+y26ypzkcd1iyWjHhmZ0cxne9VWTbW79wPquIG5dn+2lq6n17dF+Y1lkdnMl
# Ud7OsTTW/zbyD8Ea2BOWJoYS4S3gEMP4N+utLk60k20fqcS2Av8vOZcFNlwUHe4M
# K0FIXMCFHJlY2XyU1+SiX1VCiG3ng+jc+r0/dsPSeSq6dko6oooE/ShzsuAr0tMh
# fpVcZCWYJpfnvhCNw9xGlAjtm6HGiKswp6SAOLQN/pCZAcn1sFmlS+yyH6GCAg8w
...
# 9w0BCQUxDxcNMTYwMTI2MTcyNDU1WjAjBgkqhkiG9w0BCQQxFgQUygIYJMTYaHZI
# SJR15Ejo20AEXwMwDQYJKoZIhvcNAQEBBQAEggEAO1mr7k+vNONXElcOReAYrzU6
# 1ROTbgcViVxEXDSPv8C/ewEK8Pjt/DXZLqTy40FEXkmgC7a0mB31BZYlJGdsEt7T
# 3csMDtdnpu+SmDwsrAKgLsXaV01xI4qnk/gxXxqaZ+UFqaaGkLwIygULkknWYUcc
# 6ueTwhJlgm+MQZnF0O6c/H2vop6ylQDlljvCj0ffWV7N7iSlYcNZk1PF4yiaqxYm
# pJuXuC1KP4oq7YalEhEHks5I05roSrb+/8u2tsCqt9wndY7OSoka3d3Zf9vex6dm
# WAIktyA2rNSXcHyp96NwDmrLLTzk+iMsjte0cxliL6MbnsmqBBxT4M9IYPJn1g==
